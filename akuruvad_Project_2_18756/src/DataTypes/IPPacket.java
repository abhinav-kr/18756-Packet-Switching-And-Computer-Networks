...
public class IPPacket {
	 ...
	 * 
	 * @param delay
	 *            the amount of delay this packet has experienced
	 */
	...
	public String toString() {
		return this.source.getHostAddress() + " > "
				+ this.dest.getHostAddress() + " took " + this.getDelay()
				+ " time";
	}
	 ...
	 * 
	 * @param finishTime
	 *            the expected finish time of this packet
	 */
