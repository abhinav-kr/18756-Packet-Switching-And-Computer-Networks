...
public class IPNIC {
	 ...
	 * 
	 * @param IPAddress
	 *            this IP address of the nic
	 * @param parent
	 *            the parent of this nic (where the nic is)
	 */
	 ...
	 * 
	 * @param link
	 *            the cat5e cable that is connected
	 */
	...
	public void sendIPPacket(IPPacket packet) {
		if (this.link == null)
			System.err
					.println("(IPNIC) Error: The nic is not conencted to anything");
		else {
			if (trace)
