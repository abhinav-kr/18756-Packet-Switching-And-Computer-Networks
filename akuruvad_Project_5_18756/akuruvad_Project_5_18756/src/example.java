...
//		ArrayList<Integer> path = Topology.pathFromTo(r3.getAddress(), r5.getAddress());
//		for (Integer I : path) {
//			System.out.print(I+"  ");
//		}
		
//		System.out.println("\n"+Topology.nextHopFromTo(r3.getAddress(), r5.getAddress())+" ");
		...
		r1.allocateBandwidth(2, ConstStrings.PHB_EF, 0, 5);
		r1.allocateBandwidth(2, ConstStrings.PHB_AF, 1, 5);
		r1.allocateBandwidth(2, ConstStrings.PHB_AF, 2, 4);
		r1.allocateBandwidth(2, ConstStrings.PHB_AF, 3, 8);
		r1.allocateBandwidth(2, ConstStrings.PHB_BE, 0, 0);
