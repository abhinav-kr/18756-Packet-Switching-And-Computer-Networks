...
public class OtoOLink {
	...
	public OtoOLink(LSRNIC r1NIC, LSRNIC r2NIC){
		...
		Topology.addConnection(r1NIC.getParent().getAddress(), r2NIC.getParent().getAddress(), 1.0);
	}
	...
	public OtoOLink(LSRNIC r1NIC, LSRNIC r2NIC, Boolean optical){
		...
		if(optical) {
			ControlSystem.anOpticalLinkSetup(this);
		}
		Topology.addConnection(r1NIC.getParent().getAddress(), r2NIC.getParent().getAddress(), 1.0);
	}
	...
	public LSRNIC getNIC1() {
		return this.r1NIC;
	}
	
	public LSRNIC getNIC2() {
		return this.r2NIC;
	}
}
