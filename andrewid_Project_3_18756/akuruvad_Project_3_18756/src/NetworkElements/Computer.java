...
public class Computer implements IATMCellConsumer{
	...
	public void endConnection(){
		// Create the ATM cell to send
		ATMCell end = new ATMCell(this.vcNumber,"ENDCONN "+this.vcNumber, this.getTraceID());
		end.setIsOAM(true);
